<template>
	...
	<el-table :data="tableData" style="width: 100%">
		...
		<el-table-column label="操作" min-width="180">
			<template #default="scope">
				<el-button key="查看学生选课" type="primary" @click="lookChooseCourse(scope.row.id)" link>
					查看学生选课
				</el-button>
			</template>
		</el-table-column>
	...
	<el-dialog v-model="studenScoreVisible" style="max-height: 400px;overflow: auto;" title="获取已选课程" width="700">
		...
		ElMessageBox.confirm(
			...
			.then(() => {
				API({
					...
					lookChooseCourse(chooseStudent)
				}).catch((error) =>{
					ElMessage({
						type: 'warning',
