<template>
	...
	<el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px" style="width: 450px;">
		...
		<el-form-item label="紧急联系人" prop="guardian">
			<el-input v-model="ruleForm.guardian" placeholder="Please input" />

		</el-form-item>

		<el-form-item label="联系人电话" prop="guardianPhone">
			<el-input v-model="ruleForm.guardianPhone" placeholder="Please input" />
		</el-form-item>
		<el-form-item>
...
<script setup>
	...
	const submitForm = () => {
		API({
			url: "/studentApi/editStudentUser",
			method: "post",
			data: ruleForm.value
		}).then((res) => {
			ElMessage({
